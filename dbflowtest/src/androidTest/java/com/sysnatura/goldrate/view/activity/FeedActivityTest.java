...
package com.sysnatura.goldrate.view.activity;
...
import com.sysnatura.goldrate.util.DelegatingAppComponent;
...
public class FeedActivityTest extends ActivityInstrumentationTestCase2<FeedActivity> {
    ...
    public void loadFeed() {
        ...
        getActivity();
        onView(ViewMatchers.withId(com.sysnatura.goldrate.R.id.user_name)).check(matches(withText(items.get(0).getUser().getName())));
        onView(ViewMatchers.withId(com.sysnatura.goldrate.R.id.post_text)).check(matches(withText(items.get(0).getPost().getText())));
    }
    ...
    public void dontPostWithEmptyTextView() {
        ...
        getActivity();
        onView(ViewMatchers.withId(com.sysnatura.goldrate.R.id.fab)).perform(ViewActions.click());
    ...
    public void postItem() throws InterruptedException {
        ...
        when(mComponent.feedController()).thenReturn(mockFeedController);
        getActivity();
        onView(ViewMatchers.withId(com.sysnatura.goldrate.R.id.inputText))
        ...
        onView(ViewMatchers.withId(com.sysnatura.goldrate.R.id.inputText)).check(matches(withText("")));
    }

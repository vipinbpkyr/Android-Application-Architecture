...
package com.sysnatura.goldrate.view;

import com.sysnatura.goldrate.R;
...
public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.FeedItemViewHolder> {
    ...
    public FeedItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final com.sysnatura.goldrate.databinding.FeedItemBinding binding = DataBindingUtil.inflate(mLayoutInflater,
    ...
    public static class FeedItemViewHolder extends RecyclerView.ViewHolder {
        public final com.sysnatura.goldrate.databinding.FeedItemBinding binding;
        public FeedItemViewHolder(com.sysnatura.goldrate.databinding.FeedItemBinding binding) {
